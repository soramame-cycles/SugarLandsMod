...
public class SLConfiguredSurfaceBuilders {
    ...
    public static final SurfaceBuilderConfig ROTTEN_CONFIG = new SurfaceBuilderConfig(SLBlocks.ROTTEN_FLESH_BLOCK.get().defaultBlockState(), SLBlocks.ROTTEN_FLESH_BLOCK.get().defaultBlockState(), Blocks.LAVA.defaultBlockState());
    ...
    public static final ConfiguredSurfaceBuilder<SurfaceBuilderConfig> ROTTEN = SLSurfaceBuilders.ROTTEN.configured(ROTTEN_CONFIG);
    ...
    public static void registerConfigurations() {
        ...
        WorldGenRegistries.register(WorldGenRegistries.CONFIGURED_SURFACE_BUILDER, "rottenned", ROTTEN);
    }
