...
public class SLWorldGen {
    ...
    public static final Feature<NoFeatureConfig> GEN_ROTTEN_DELTA = new RottenWastePillar(NoFeatureConfig.CODEC);
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> ROTTEN_DELTA = SLWGEN.register("roten_delta", ()-> GEN_ROTTEN_DELTA);
