...
public class SLBiomes {
    ...
    public static final RegistryObject<Biome> ROTTEN_WASTES_REGISTRY = SLB.register(rotten_wastes, ()-> new Biome.Builder()
            .generationSettings(SLBiomeFeatures.rottenWasteSettings().surfaceBuilder(SLConfiguredSurfaceBuilders.ROTTEN).build())
            .biomeCategory(Category.NETHER)
            .depth(0.1F)
            .downfall(0)
    ...
    public static void addBiomeTypes() {
        ...
        BiomeDictionary.addTypes(ROTTEN_WASTES,Type.NETHER,Type.HOT,Type.DRY);
    }
    public static void addBiome() {
        ...
        BiomeManager.addBiome(BiomeType.WARM, new BiomeEntry(ROTTEN_WASTES, 1));
    }
    public static void addNetherBiome() {
        //????????
        new NetherBiomeProvider.Preset(ROTTEN_WASTES.getRegistryName(), (pre,regi,seed)->{
            return pre.biomeSource(regi, seed);
        });
