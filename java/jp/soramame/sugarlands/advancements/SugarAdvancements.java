...
public class SugarAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    private static final List<RegistryKey<Biome>> EXPLORABLE_BIOMES = ImmutableList.of(SLBiomes.SUGAR_DESERT,SLBiomes.SUGAR_FOREST,SLBiomes.PUDDING_PLAIN,SLBiomes.ICECANDY_SPIKES,SLBiomes.ROTTEN_WASTES);
