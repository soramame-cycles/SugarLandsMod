...
public class SLSurfaceBuilders {
	...
	//public static RegistryKey<SurfaceBuilder<?>> ROTTEN_SARFACE_REGISTRY = register("rotten_sarface");

	private static RegistryKey<SurfaceBuilder<?>> register(String name){
	...
	//public static final SurfaceBuilder<SurfaceBuilderConfig> ROTTEN = new RottenWasteSurfaceBuilder(SurfaceBuilderConfig.CODEC);
	...
	//public static final RegistryObject<SurfaceBuilder<SurfaceBuilderConfig>> ROTTEN_SARFACE =
	//		SLSurface.register("rotten_sarface", ()->ROTTEN);
