...
public class SLJaJpLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add(SLBiomes.SUGAR_DESERT_REGISTRY.get(), "砂糖砂漠");
		add(SLBiomes.PUDDING_PLAIN_REGISTRY.get(), "プリン平原");
		add(SLBiomes.SUGAR_FOREST_REGISTRY.get(), "砂糖の森林");
		add(SLBiomes.ICECANDY_SPIKES_REGISTRY.get(), "樹氷菓");
