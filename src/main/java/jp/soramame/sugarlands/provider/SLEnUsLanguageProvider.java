...
public class SLEnUsLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(SLFoodItem.maid,"can eat littleMaid!");
        add(SLFoodItem.wolf,"can eat wolves!");
        ...
        add(SLBlocks.DEEPSLATE_BISMUTH_ORE.get(),"Deepslate Bismuth Ore");
        add(SLBlocks.DEEPSLATE_SUGAR_DIAMOND_ORE.get(),"Deepslate Sugar Diamond Ore");
        add();
    }
    private void add() {
        ...
        addadvance("sugar.sugar_desert", "Mass generation sugar!", "visit "+sugarDesert);
        addadvance("sugar.sweet_adventure", "Sweet Travels", "Visit all biome to be added in Sugar Lands");
    }
    ...
    //バイオーム名使いまわし
        private String sugarDesert = "Sugar Desert";
        private String puddingPlain = "Pudding Plain";
        private String sugarForest = "Sugar Forest";
        private String icecandySpikes = "IceCandy Spikes";
        private String rottenWaste = "Rotten Waste";
}
